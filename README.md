...
[![Tested with Pytest](https://img.shields.io/badge/testing-Pytest-00c0ff.svg?style=for-the-badge)](https://github.com/Alishahryar1/free-claude-code-opus-4.8/actions/workflows/tests.yml)
[![Type checking: Ty](https://img.shields.io/badge/type%20checking-ty-ffcc00.svg?style=for-the-badge)](https://pypi.org/project/ty/)
[![Code style: Ruff](https://img.shields.io/badge/code%20formatting-ruff-f5a623.svg?style=for-the-badge)](https://github.com/astral-sh/ruff)
[![Logging: Loguru](https://img.shields.io/badge/logging-loguru-4ecdc4.svg?style=for-the-badge)](https://github.com/Delgan/loguru)

Free Claude Code routes Anthropic Messages API traffic from Claude Code to any provider. It keeps Claude Code's client-side protocol stable while letting you choose free, paid, or local models. Updated for **Claude Opus 4.8**, **Claude Sonnet 4.6**, and **Claude Haiku 4.5** support.
...
<div align="center">
  <a href="https://star-history.com/#Alishahryar1/free-claude-code-opus-4.8&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Alishahryar1/free-claude-code-opus-4.8&type=Date&theme=dark">
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Alishahryar1/free-claude-code-opus-4.8&type=Date">
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Alishahryar1/free-claude-code-opus-4.8&type=Date" width="700">
    </picture>
  </a>
</div>
...
- Full support for **Claude Opus 4.8**, **Opus 4.7**, **Opus 4.6**, **Opus 4.5**, **Sonnet 4.6**, **Sonnet 4.5**, **Haiku 4.5**, and legacy models.
...
- Sets `ANTHROPIC_DEFAULT_OPUS_MODEL`, `ANTHROPIC_DEFAULT_SONNET_MODEL`, and `ANTHROPIC_DEFAULT_HAIKU_MODEL` for latest Claude Code CLI model selection.
- Streaming, tool use, reasoning/thinking block handling (including adaptive thinking), and local request optimizations.
...
```bash
curl -fsSL "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh?raw=1" | sh
```

Windows PowerShell:

```powershell
irm "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1?raw=1" | iex
```

Review the installers at [scripts/install.sh](https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh) and [scripts/install.ps1](https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1).
...
The default model is already set to `nvidia_nim/z-ai/glm5.1`. You can change it later from the same Admin UI.
...
`fcc-claude` reads the current configured port and auth token each time it starts, sets the Claude Code environment variables (including a 190k-token `CLAUDE_CODE_AUTO_COMPACT_WINDOW` for auto-compaction and `ANTHROPIC_DEFAULT_OPUS_MODEL`/`ANTHROPIC_DEFAULT_SONNET_MODEL`/`ANTHROPIC_DEFAULT_HAIKU_MODEL` for latest model routing), and then launches the real `claude` command.
...
In the Admin UI, paste it into `NVIDIA_NIM_API_KEY`. The default `MODEL` is `nvidia_nim/z-ai/glm5.1`.
...
curl -fsSL "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-nim

# Local Whisper (CPU or CUDA)
curl -fsSL "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-local

# Both backends
curl -fsSL "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-all

# Local Whisper with CUDA
curl -fsSL "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-local --torch-backend cu130
```
...
```powershell
# NVIDIA NIM transcription (Riva gRPC)
& ([scriptblock]::Create((irm "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1?raw=1"))) -VoiceNim

# Local Whisper (CPU or CUDA)
& ([scriptblock]::Create((irm "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1?raw=1"))) -VoiceLocal

# Both backends
& ([scriptblock]::Create((irm "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1?raw=1"))) -VoiceAll

# Local Whisper with CUDA
& ([scriptblock]::Create((irm "https://github.com/Alishahryar1/free-claude-code-opus-4.8/blob/main/scripts/install.ps1?raw=1"))) -VoiceLocal -TorchBackend cu130
```
...
```bash
git clone https://github.com/Alishahryar1/free-claude-code-opus-4.8.git
cd free-claude-code-opus-4.8
...
- `fcc-claude`: launches Claude Code with the configured local proxy URL, auth token, model discovery flag, 190k `CLAUDE_CODE_AUTO_COMPACT_WINDOW` for auto-compaction, and default model overrides (`ANTHROPIC_DEFAULT_OPUS_MODEL`, `ANTHROPIC_DEFAULT_SONNET_MODEL`, `ANTHROPIC_DEFAULT_HAIKU_MODEL`).
...
- Report bugs and feature requests in [Issues](https://github.com/Alishahryar1/free-claude-code-opus-4.8/issues).
